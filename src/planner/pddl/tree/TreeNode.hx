...
class TreeNode
{
	...
	public function GenerateRangeOfValues(data_:ActionData, valueName_:String, state_:State, domain_:Domain, heuristic_version_:Bool):Array<String> { throw "must override this function"; }

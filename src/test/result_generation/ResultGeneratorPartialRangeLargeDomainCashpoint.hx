...
class ResultGeneratorPartialRangeLargeDomainCashpoint
{
	...
	public function Run(domain_path_:String, problem_path_:String, domain_size_:Int, problem_atm_1:Int, problem_atm_2:Int, ratio_:Float):Bool
	{		
		var domain_path:String = domain_path_;
		var problem_path:String = problem_path_;
		var results_path:String = problem_path_ + "_results.txt";
		...
		Main.Assert(changing_node.GetParent().toString() == ">= (inPocket joe)  (20) ", "Base problem file has changed: ResultGeneratorPartialRangeLargeDomainCashpoint");

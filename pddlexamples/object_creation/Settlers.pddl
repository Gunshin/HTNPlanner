(define (domain civ) 
  ...
  (:action move-cart 
   :parameters (?v - cart ?p1 - place ?p2 - place) 
   :precondition (and 
  ...
  (:action move-train 
   :parameters (?v - train ?p1 - place ?p2 - place) 
   :precondition (and 
  ...
  (:action move-ship 
   :parameters (?v - ship ?p1 - place ?p2 - place) 
   :precondition (and  
  ...
  (:action build-train 
   :parameters (?p - place)
   :new_objects (?v - train)
   :precondition (and (>= (available iron ?p) 2))
  ...
  (:action build-ship 
   :parameters (?p - place) 
   :new_objects (?v - ship)
   :precondition (and (>= (available iron ?p) 4))
